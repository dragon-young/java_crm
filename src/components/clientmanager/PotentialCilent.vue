<template>
    <div>
        ...
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>潜在客户管理</el-breadcrumb-item>
        </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    async getPotentialClientInfo () {
      const { data: res } = await this.$http.get(`customer/queryForList?currentPage=${this.pageNum.currentPage}&pageSize=${this.pageNum.pageSize}&status=0`)
    ...
    async followUpInfo () {
      this.followUpForm.inputUserId = 1
